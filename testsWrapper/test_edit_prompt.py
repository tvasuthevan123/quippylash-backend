...
request_url = config.settings['cloud_URI'] + 'prompt/edit/'
...
class TestFunction(unittest.TestCase):
    ...
    def test_edit_prompt__valid(self):
        ...
        edit_response = wrapper.prompt_edit(payload, local=True)
    ...
    def test_edit_prompt__duplicate(self):
        ...
        create_response = wrapper.prompt_edit(payload, local=True)
